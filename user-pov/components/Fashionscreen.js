  ...
  return (
    <ScrollView vertical style={styles.container}>
      <View style={styles.imageContainer}>
        <Image
          source={require('../assets/Homescreen_assets/model.png')}
          style={styles.image}
          resizeMode="cover"
        />
      </View>
      ...
      <ScrollView horizontal style={styles.gridContainer}>
        <View style={styles.imageGrid}>
          <Image
            source={require('../assets/Homescreen_assets/image1.png')}
            style={styles.gridImage}
            resizeMode="cover"
          />
          <Image
            source={require('../assets/Homescreen_assets/image2.png')}
            style={styles.gridImage}
            resizeMode="cover"
          />
          <Image
            source={require('../assets/Homescreen_assets/image3.png')}
            style={styles.gridImage}
            resizeMode="cover"
          />
          <Image
            source={require('../assets/Homescreen_assets/image4.png')}
            style={styles.gridImage}
            resizeMode="cover"
          />
        </View>
