  ...
  return (
    <View style={styles.headerContainer}>
      <View style={styles.topBar}>
        <View style={styles.leftContainer}>
          <TouchableOpacity onPress={() => console.log('Forward pressed')}>
            <Image
              source={require('../assets/Homescreen_assets/forward.png')}
              style={styles.forwardicon}
            />
          </TouchableOpacity>
          <View style={styles.becomeInsider}>
            <Image
              source={require('../assets/Homescreen_assets/crown.png')}
              style={styles.icon}
            />
          </View>
        ...
        <View style={styles.rightContainer}>
          <TouchableOpacity onPress={() => console.log('Notifications pressed')}>
            <Image
              source={require('../assets/Homescreen_assets/notification.png')}
              style={styles.icon}
            />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => console.log('Heart pressed')}>
            <Image
              source={require('../assets/Homescreen_assets/Heart.png')}
              style={styles.icon}
            />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => console.log('Bag pressed')}>
            <Image
              source={require('../assets/Homescreen_assets/bag.png')}
              style={styles.icon}
            />
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.searchBar}>
        <Image
          source={require('../assets/Homescreen_assets/search.png')}
        ...
        <View style={styles.searchIconsRight}>
          <TouchableOpacity onPress={() => console.log('Camera pressed')}>
            <Image
              source={require('../assets/Homescreen_assets/camera.png')}
              style={styles.searchIconRight}
            />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => console.log('Mic pressed')}>
            <Image
              source={require('../assets/Homescreen_assets/mic.png')}
              style={styles.searchIconRight}
            />
          </TouchableOpacity>
        </View>
